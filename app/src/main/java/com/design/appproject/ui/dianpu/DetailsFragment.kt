...
import com.design.appproject.logic.viewmodel.dianpu.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.DianpucommonDetailsLayoutBinding
 ...
 * 店铺详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_DIANPU)
class DetailsFragment : BaseBindingFragment<DianpucommonDetailsLayoutBinding>() {
    ...
    private var mDianpuItemBean=DianpuItemBean()/*详情内容*/
    ...
    private fun loadData(){
        mDetailsViewModel.info("dianpu",mId.toString())
    }


    private fun DianpucommonDetailsLayoutBinding.setInfo(){
        dianpumingchengTv.text = "${mDianpuItemBean.dianpumingcheng}"
        dianpumimaTv.text = "${mDianpuItemBean.dianpumima}"
        banner.setAdapter(DetailBannerAdapter(mDianpuItemBean.dianputupian.split(","))).setOnBannerListener { data, position ->
            data.toConversion<String>()?.let {
                it.showToast()
            }
        }
        yingyeshijianTv.text = "${mDianpuItemBean.yingyeshijian}"
        lianxidianhuaTv.text = "${mDianpuItemBean.lianxidianhua}"
        dianpudizhiTv.text = "${mDianpuItemBean.dianpudizhi}"
    }
