...
import com.design.appproject.logic.viewmodel.menu.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.MenucommonDetailsLayoutBinding
 ...
 * 菜单详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_MENU)
class DetailsFragment : BaseBindingFragment<MenucommonDetailsLayoutBinding>() {
    ...
    private var mMenuItemBean=MenuItemBean()/*详情内容*/
    ...
    private fun loadData(){
        mDetailsViewModel.info("menu",mId.toString())
    }


    private fun MenucommonDetailsLayoutBinding.setInfo(){
        menujsonTv.text = "${mMenuItemBean.menujson}"
    }
