...
import com.design.appproject.logic.viewmodel.fuwuleixing.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.FuwuleixingcommonDetailsLayoutBinding
 ...
 * 服务类型详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_FUWULEIXING)
class DetailsFragment : BaseBindingFragment<FuwuleixingcommonDetailsLayoutBinding>() {
    ...
    private var mFuwuleixingItemBean=FuwuleixingItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mFuwuleixingItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("fuwuleixing",mId.toString())
    }


    private fun FuwuleixingcommonDetailsLayoutBinding.setInfo(){
        fuwuleixingTv.text = "${mFuwuleixingItemBean.fuwuleixing}"
    }
