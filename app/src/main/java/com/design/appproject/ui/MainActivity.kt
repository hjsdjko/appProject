...
class MainActivity : BaseBindingActivity<ActivityMainLayoutBinding>() {
    ...
    private val fragments = mutableListOf(
        ...
        ARouter.getInstance().build(CommonArouteApi.PATH_FRAGMENT_LIST_DIANPU).withBoolean("mHasBack",false).navigation() as Fragment,
        ARouter.getInstance().build(CommonArouteApi.PATH_FRAGMENT_LIST_FUWUXIANGMU).withBoolean("mHasBack",false).navigation() as Fragment,
        ARouter.getInstance().build(CommonArouteApi.PATH_FRAGMENT_LIST_MAP).navigation() as Fragment,
