 ...
 * 服务预约适配器列表
 */
class ListAdapter : LoadMoreAdapter<List<FuwuyuyueItemBean>>(R.layout.fuwuyuyue_list_item_layout) {

    var mIsBack = false/*是否后台进入*/
    override fun convert(holder: BaseViewHolder, item: List<FuwuyuyueItemBean>) {
        ...
        holder.setText(R.id.fuwuzhuangtai1_tv,"服务状态:"+ dataOne.fuwuzhuangtai)
        mIsBack.yes {
            holder.setGone(R.id.edit1_fl,!Utils.isAuthBack("fuwuyuyue","修改"))
            holder.setGone(R.id.edit2_left_fl,!Utils.isAuthBack("fuwuyuyue","修改"))
            holder.setGone(R.id.edit2_right_fl,!Utils.isAuthBack("fuwuyuyue","修改"))
            holder.setGone(R.id.edit3_fl,!Utils.isAuthBack("fuwuyuyue","修改"))
            holder.setGone(R.id.edit4_left_fl,!Utils.isAuthBack("fuwuyuyue","修改"))
            holder.setGone(R.id.edit4_right_fl,!Utils.isAuthBack("fuwuyuyue","修改"))
            holder.setGone(R.id.delete1_fl,!Utils.isAuthBack("fuwuyuyue","删除"))
            holder.setGone(R.id.delete2_left_fl,!Utils.isAuthBack("fuwuyuyue","删除"))
            holder.setGone(R.id.delete2_right_fl,!Utils.isAuthBack("fuwuyuyue","删除"))
            holder.setGone(R.id.delete3_fl,!Utils.isAuthBack("fuwuyuyue","删除"))
            holder.setGone(R.id.delete4_left_fl,!Utils.isAuthBack("fuwuyuyue","删除"))
            holder.setGone(R.id.delete4_right_fl,!Utils.isAuthBack("fuwuyuyue","删除"))
        }.otherwise {
            holder.setGone(R.id.edit1_fl,!Utils.isAuthFront("fuwuyuyue","修改"))
            holder.setGone(R.id.edit2_left_fl,!Utils.isAuthFront("fuwuyuyue","修改"))
            holder.setGone(R.id.edit2_right_fl,!Utils.isAuthFront("fuwuyuyue","修改"))
            holder.setGone(R.id.edit4_left_fl,!Utils.isAuthFront("fuwuyuyue","修改"))
            holder.setGone(R.id.edit4_right_fl,!Utils.isAuthFront("fuwuyuyue","修改"))
            holder.setGone(R.id.edit3_fl,!Utils.isAuthFront("fuwuyuyue","修改"))
            holder.setGone(R.id.delete1_fl,!Utils.isAuthFront("fuwuyuyue","删除"))
            holder.setGone(R.id.delete2_left_fl,!Utils.isAuthFront("fuwuyuyue","删除"))
            holder.setGone(R.id.delete2_right_fl,!Utils.isAuthFront("fuwuyuyue","删除"))
            holder.setGone(R.id.delete3_fl,!Utils.isAuthFront("fuwuyuyue","删除"))
            holder.setGone(R.id.delete4_left_fl,!Utils.isAuthFront("fuwuyuyue","删除"))
            holder.setGone(R.id.delete4_right_fl,!Utils.isAuthFront("fuwuyuyue","删除"))
        }
        ...
        if (item.size>1){
            ...
            holder.setGone(R.id.left_fuwuzhuangtai2_tv,!true)
            holder.setText(R.id.left_fuwuzhuangtai2_tv,"服务状态:"+ dataTwo.fuwuzhuangtai)
        }
        ...
        if (item.size>2){
            ...
            holder.setGone(R.id.right_fuwuzhuangtai2_tv,!true)
            holder.setText(R.id.right_fuwuzhuangtai2_tv,"服务状态:"+ dataThree.fuwuzhuangtai)
        }
        ...
        if (item.size>3){
            ...
            holder.setGone(R.id.fuwuzhuangtai3_tv,!true)
            holder.setText(R.id.fuwuzhuangtai3_tv,"服务状态:"+ dataFour.fuwuzhuangtai)
        }
        ...
        if (item.size>4){
            ...
            holder.setGone(R.id.left_fuwuzhuangtai4_tv,!true)
            holder.setText(R.id.left_fuwuzhuangtai4_tv,"服务状态:"+ dataFive.fuwuzhuangtai)
        }
        ...
        if (item.size>5){
            ...
            holder.setGone(R.id.right_fuwuzhuangtai4_tv,!true)
            holder.setText(R.id.right_fuwuzhuangtai4_tv,"服务状态:"+ dataSix.fuwuzhuangtai)
        }
    }
}